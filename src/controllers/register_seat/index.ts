import { createRegisterSeatService, listPatientHistoryService, listRelatoriesService } from "../../services/register_seat";
...
export { createRegisterSeatController, listRelatoriesController, listPatientHistoryController };